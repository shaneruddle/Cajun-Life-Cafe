...
export default function ActivatePage() {
  ...
  const handleLineLogin = () => {
    window.location.href = `/api/activate/${token}/line-login`;
  };
    ...
    <div className="min-h-screen bg-cream flex items-center justify-center p-6">
      <div className="bg-white rounded-3xl p-8 max-w-sm w-full text-center shadow-lg space-y-6">
        ...
        <button
          ...
          className="w-full py-4 rounded-2xl font-bold text-white flex items-center justify-center gap-3 shadow-lg transition-all hover:opacity-90"
