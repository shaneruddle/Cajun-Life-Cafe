        ...
        {customer ? (
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
            <div className="flex flex-col items-center justify-center py-12 text-center space-y-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-ink">Select a Member</h3>
                <p className="text-gray-400 max-w-xs mx-auto">Search above or pick from the list below</p>
              </div>
            </div>
              ...
              <div className="max-h-[500px] overflow-y-auto divide-y divide-gray-50">
                ...
                {filteredMembers.length === 0 && (
                  <div className="p-12 text-center text-gray-400 italic">
                    No loyalty members yet. Enroll customers from the CRM directory.
                  </div>
                )}
              </div>
            </div>
